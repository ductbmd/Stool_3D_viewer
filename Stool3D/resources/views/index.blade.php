...
<body>
    ...
    <script>
        ...
        function init() {
            ...
            mtlLoader.setBaseUrl('{{ asset('assets/female-croupier-2013-03-26.png')}}');
            mtlLoader.setPath('{{ asset('assets/female-croupier-2013-03-26.png')}}');
            mtlLoader.load('{{ asset('female-croupier-2013-03-26.mtl')}}', function (materials) {
